...
* Load raw files
* Write merged raw files into station_files/stations_raw/merged folder
* Convert fahrenheit to celsius
* Create a "Temp" column so celsius and fahrenheit have the same column name
* Merge stations into station_files/stations_std/merged_std folder
