...
server <- function(input, output) {
  ...
  # GitHub
  githuburl <- a("https://github.com/InteragencyEcologicalProgram/TempSynthesis", href = "https://github.com/InteragencyEcologicalProgram/TempSynthesis")
  output$github <- renderUI({
    tagList("Find most updated app code at:", githuburl)
  })
