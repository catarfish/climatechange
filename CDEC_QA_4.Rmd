...
test = temp_q2_a[1:200000,]

test$Flag_QC2_b = NA

bad = which(test$Flag_QC2_a == "Y")

#maybe a fucntion will help

foo =  map(bad, function(x) {
  for (i in 1:nrow(test)) {
    if_else( (test[x] - testx[i <= 10, test[i]
  

  ifelse(test$Flag_QC2_a == "Y")
}
  )
