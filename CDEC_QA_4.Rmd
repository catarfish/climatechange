...
(Flagged_stations <- temp_flags %>%
  ...
  summarize(Init = n(),
            ...
            Pct_Flagged_QC1 = round(QC1/Init*100,1),
            Pct_Flagged_QC2 = round(QC2/Init*100,1),
            Pct_Flagged_QC3 = round(QC3/Init*100,1),
            Pct_Flagged_QC4 = round(QC4/Init*100,1),
            Pct_Flagged_QC5 = round(QC5/Init*100,1),
            Pct_Flagged_QC6 = round(QC6/Init*100,1),
            Pct_Flagged_Total = round(QCTot/Init * 100,1) ))

write(Flagged_stations, "Tempdata/QC/Flagged_Percentages.csv")
# Overall dataset
Flags <- temp_flags %>%
